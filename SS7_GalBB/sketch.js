...
function setup() {
  ...
  textAlign(CENTER);
  textSize(30);
  deadtext = new dead(width/2, height/2);
  //start text
  scenetext [0] = text('Welcome to Riveria,', 450, 50);
  scenetext [1] = text('A world filled with magic, swords, and everything in between', 450, 100);
  scenetext [2] = text('Choose your starting point', 450, 150);
  //cave text
  scenetext [3] = text('You wake up in a dark cave', 450, 50);
  scenetext [4] = text('You notice glowing writing on the wall', 450, 100);
  scenetext [5] = text('What do you do?', 450, 150);
  //forest text
  scenetext [6] = text('You wake up in a dense forest', 450, 50);
  scenetext [7] = text('You notice scratchs on the trees', 450, 100);
  scenetext [8] = text('What do you do?', 450, 150);
  //ship text
  scenetext [9] = text('You wake up amongst the wreckege of a ship', 450, 50);
  scenetext [10] = text('The water is freezing', 450, 100);
  scenetext [11] = text('What do you do?', 450, 150);
